#!/usr/bin/env python3
"""Verify the Coexistence Impact Engine demo video has usable video and audio streams."""
...
VIDEO = ROOT / "media" / "coexistence-impact-engine-demo.mp4"


def main() -> int:
    if not VIDEO.exists():
        print(f"impact_demo_video_missing={VIDEO}")
        return 1
    ...
    if failures:
        print("impact_demo_video_failed")
        for failure in failures:
            print(f"- {failure}")
        return 1

    print("impact_demo_video_ok")
